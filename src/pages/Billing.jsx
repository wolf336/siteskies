  ...
  return (
    <div className="space-y-8 max-w-5xl">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Manage your plan, usage and team members.</p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          {/* Left column: current plan info + usage */}
            ...
            <div className="flex items-center justify-between">
              ...
              <Tabs value={billingInterval} onValueChange={setBillingInterval}>
                <TabsList>
                  ...
                  <TabsTrigger value="yearly">Yearly <span className="ml-1 text-[10px] text-success font-semibold">Save ~8%</span></TabsTrigger>
                </TabsList>
              </Tabs>
            </div>
